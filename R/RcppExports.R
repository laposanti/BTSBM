...
pl_grouped_augmentation_cpp <- function(rankings, ranking_cluster, latent_strength) {
    .Call(`_BTSBM_pl_grouped_augmentation_cpp`, rankings, ranking_cluster, latent_strength)
}
